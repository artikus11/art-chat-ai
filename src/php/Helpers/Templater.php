...
class Templater {
	...
	public function get_template( string $template_name ): string {
		...
		return apply_filters( Utils::get_plugin_prefix() . '_locate_template', $template_path );
	}
	...
	public function template_path(): string {
		...
		return apply_filters( Utils::get_plugin_prefix() . '_template_path', 'art-woocommerce-product-option/' );
	}
